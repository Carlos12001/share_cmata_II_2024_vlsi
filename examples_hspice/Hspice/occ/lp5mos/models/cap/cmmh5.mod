...
* Simulator : HSPICE
* Device    : cmmh5
* Desc      : single MIM capacitor (high capacitance) between metal4 and metal5
...
*
.subckt cmmh5 n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  cmmh5_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='cmmh_ca'
+ cp_i='cmmh_cp'
