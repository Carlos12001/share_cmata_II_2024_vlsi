...
* Simulator : HSPICE
* Device    : cdmm5
* Desc      : double MIM capacitor between metal3, metal4 and metal5
...
*
.subckt cdmm5 n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  cdmm5_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='cdmm_ca'
+ cp_i='cdmm_cp'
