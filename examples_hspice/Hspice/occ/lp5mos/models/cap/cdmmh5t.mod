...
* Simulator : HSPICE
* Device    : cdmmh5t
* Desc      : double MIM capacitor (high capacitance) between metal3, metal4 and metaltop
...
*
.subckt cdmmh5t n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  cdmmh5t_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='cdmmh_ca'
+ cp_i='cdmmh_cp'
