...
* Simulator : HSPICE
* Device    : cmmh4t
* Desc      : single MIM (high cap) capacitor MET3/METTP
...
*
.subckt cmmh4t n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  cmmh4t_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='cmmh_ca'
+ cp_i='cmmh_cp'
