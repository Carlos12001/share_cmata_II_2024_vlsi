...
* Simulator : HSPICE
* Device    : cmmh4l
* Desc      : single MIM capacitor (high capacitance) between metal3 and metal thick
...
*
.subckt cmmh4l n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  cmmh4l_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='cmmh_ca'
+ cp_i='cmmh_cp'
