...
* Simulator : HSPICE
* Device    : cdmm4t
* Desc      : single MIM capacitor MET2/MET3/METTP
...
*
.subckt cdmm4t n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  cdmm4t_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='cdmm_ca'
+ cp_i='cdmm_cp'
