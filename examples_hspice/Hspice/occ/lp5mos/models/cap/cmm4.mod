...
* Simulator : HSPICE
* Device    : cmm4
* Desc      : single MIM capacitor MET3/MET4
...
*
.subckt cmm4 n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  cmm4_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='cmm_ca'
+ cp_i='cmm_cp'
