...
* Simulator : HSPICE
* Device    : cmm6t
* Desc      : single MIM capacitor MET5/METTP
...
*
.subckt cmm6t n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  cmm6t_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='cmm_ca'
+ cp_i='cmm_cp'
