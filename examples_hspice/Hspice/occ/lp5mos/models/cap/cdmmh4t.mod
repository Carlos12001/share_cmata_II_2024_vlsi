...
* Simulator : HSPICE
* Device    : cdmmh4t
* Desc      : double MIM capacitor (high capacitance) between metal2, metal3 and metal4
...
*
.subckt cdmmh4t n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  cdmmh4t_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='cdmmh_ca'
+ cp_i='cdmmh_cp'
