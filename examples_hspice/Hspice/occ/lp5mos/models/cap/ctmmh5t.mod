...
* Simulator : HSPICE
* Device    : ctmmh5t
* Desc      : single MIM (high cap) capacitor MET2/MET3/MET4/METTP
...
*
.subckt ctmmh5t n1 n2 area=100e-12 perimeter=40e-6 par1=1 
xocc_m1 n1 n2  ctmmh5t_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param ca_i='ctmmh_ca'
+ cp_i='ctmmh_cp'
