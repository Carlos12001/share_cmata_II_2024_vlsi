...
*
.subckt qpvha c_enh b_enh e_enh le=10 par1=1 
xocc_m1 c_enh b_enh e_enh c b e  qpvha_ahdl tstep_occ=tstep_soac le=le maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
