...
* Simulator : HSPICE
* Device    : dnpati
* Desc      : 8V N-type protection diode (DTI)
...
*
.subckt dnpati a_enh c_enh area=1e-12 perimeter=4e-6 pgate=0 dbv=0 xf_subext=0 par1=1 m_soa=1 
xocc_m1 a_enh c_enh a c  dnpati_ahdl tstep_occ=tstep_soac area=area maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.if ( xf_subext==0 )
rs a b r='dnpa_rs_res_mul*(9.15E-11/area)'
+ tc1=9.492e-04 tc2=-1.666e-07
d1 b c dnpatid1 area=area pj='0' pgate=pgate
d2 b c dnpatid2 area=area
.endif
*
.model dnpatid1 d level=6
