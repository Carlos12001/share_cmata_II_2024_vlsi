...
* Spec.     : PDS_018_06
* Revision  : 7.0.0.A2.1; 2018-06-29
* ----------------------------------------------------------------------
*                        PARAMETERIZED
* ----------------------------------------------------------------------
...
*
.subckt dfwpsj1b_16 a c area=1e-12 perimeter=4e-6 pgate=0 dbv=0 par1=1 m_soa=1
d1 a c dfwpsj1b_16d1 ab=area ls='0' lg=pgate
d2 a c dfwpsj1b_16d2 area=area
*
.model dfwpsj1b_16d1 d level=7
...
+ vbrbot='1.000e+00*(dbv+2.766e+02)'
+ vbrsti='1.000e+00*(dbv+2.766e+02)'
+ vbrgat='1.000e+00*(dbv+2.766e+02)'
