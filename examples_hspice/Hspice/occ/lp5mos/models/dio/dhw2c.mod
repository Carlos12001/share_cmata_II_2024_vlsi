...
* Simulator : HSPICE
* Device    : dhw2c
* Desc      : 160V Gen2 handle wafer diode
...
*
.subckt dhw2c a c area=1e-12 perimeter=4e-6 pgate=0 dbv=0 xf_subext=0 par1=1 m_soa=1 
xocc_m1 a c  dhw2c_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.if ( xf_subext==0 )
rs a b r='dhw2c_rs_res_mul*(8.86E-07/area)'
+ tc1=2.000e-03 tc2=0.000e+00
d1 b c dhw2cd1 area=area pj=perimeter pgate=pgate
d2 b c dhw2cd2 area=area
.endif
*
.model dhw2cd1 d level=6
