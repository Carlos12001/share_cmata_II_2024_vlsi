...
*
.subckt dzati a_enh c_enh area=1e-12 perimeter=4e-6 pgate=0 dbv=0 xf_subext=0 par1=1 m_soa=1 
xocc_m1 a_enh c_enh a c  dzati_ahdl tstep_occ=tstep_soac area=area maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.if ( xf_subext==0 )
rs a b r='dzati_rs_res_mul*(12.88+2.461E-11/area)'
+ tc1=1.789e-03 tc2=-1.275e-05
d1 b c dzatid1 area=area pj=perimeter pgate=pgate
d2 b c dzatid2 area=area
.endif
*
.model dzatid1 d level=6
