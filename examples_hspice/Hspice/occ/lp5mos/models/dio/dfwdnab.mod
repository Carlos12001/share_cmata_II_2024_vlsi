...
* Simulator : HSPICE
* Device    : dfwdnab
* Desc      : parasitic diode drain / bulk for nmvab
...
*
.subckt dfwdnab a_enh c_enh area=1e-12 perimeter=4e-6 pgate=0 dbv=0 par1=1 m_soa=1 
xocc_m1 a_enh c_enh a c  dfwdnab_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
d1 a c dfwdnabd1 ab=area ls=perimeter lg=pgate
d2 a c dfwdnabd2 area=area
*
.model dfwdnabd1 d level=7
