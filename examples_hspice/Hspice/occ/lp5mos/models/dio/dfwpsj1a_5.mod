...
* Simulator : HSPICE
* Device    : dfwpsj1a_5
* Desc      : diode drain / bulk for phsj1a_5
...
*
.subckt dfwpsj1a_5 a c area=1e-12 perimeter=4e-6 pgate=0 dbv=0 par1=1 m_soa=1 
xocc_m1 a c  dfwpsj1a_5_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
d1 a c dfwpsj1a_5d1 ab='area' ls=perimeter lg=pgate
d2 a c dfwpsj1a_5d2 area='area'
*
.model dfwpsj1a_5d1 d level=7
