...
*
.subckt dfwnsj1_10 a c area=1e-12 perimeter=4e-6 pgate=0 dbv=0 par1=1 m_soa=1 
xocc_m1 a c  dfwnsj1_10_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
d1 a c dfwnsj1_10d1 ab=area ls='0' lg=pgate
d2 a c dfwnsj1_10d2 area=area
*
.model dfwnsj1_10d1 d level=7
