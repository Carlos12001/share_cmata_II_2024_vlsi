...
* Simulator : HSPICE
* Device    : dfwpsj1a_4
* Desc      : diode drain / bulk for phsj1a_4
...
*
.subckt dfwpsj1a_4 a c area=1e-12 perimeter=4e-6 pgate=0 dbv=0 par1=1 m_soa=1 
xocc_m1 a c  dfwpsj1a_4_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
d1 a c dfwpsj1a_4d1 ab='area' ls=perimeter lg=pgate
d2 a c dfwpsj1a_4d2 area='area'
*
.model dfwpsj1a_4d1 d level=7
