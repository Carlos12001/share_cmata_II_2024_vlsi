...
* Simulator : HSPICE
* Device    : dfwpsj2b_16
* Desc      : diode drain / bulk for phsj2b_16
...
*
.subckt dfwpsj2b_16 a_enh c_enh area=1e-12 perimeter=4e-6 pgate=0 dbv=0 par1=1 m_soa=1 
xocc_m1 a_enh c_enh a c  dfwpsj2b_16_ahdl tstep_occ=tstep_soac area=area maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
d1 a c dfwpsj2b_16d1 ab='area' ls=perimeter lg=pgate
d2 a c dfwpsj2b_16d2 area='area'
*
.model dfwpsj2b_16d1 d level=7
