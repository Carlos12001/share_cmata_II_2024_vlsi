...
* Simulator : HSPICE
* Device    : rdn5
* Desc      : 5.0V NDIFF / PWELL2 resistor (non salicided)
...
*            3) pm=n  : n contacts
*
.subckt rdn5 n1 n2 nb l=10e-6 w=10e-6 xf_subext=0 pm=-1 par1=1 
xocc_m1 n1 n2 nb  rdn5_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
r1 na nc rdn5mod r='r0/2'
+ l='l/2' w=w
r2 nc nd rdn5mod r='r0/2'
+ l='l/2' w=w
.model rdn5mod r
+ tc1=tc1r                     tc2=tc2r
