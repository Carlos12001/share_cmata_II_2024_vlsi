...
* ! bulk voltage dependency is not modelled !
*
.subckt rpp1k1 n1_enh n2_enh l=10e-6 w=10e-6 pm=-1 par1=1 
xocc_m1 n1_enh n2_enh n1 n2  rpp1k1_ahdl tstep_occ=tstep_soac w=w maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
r1 na nc rpp1k1mod r='r0/2'
+ l='l/2' w=w
r2 nc nd rpp1k1mod r='r0/2'
+ l='l/2' w=w
.model rpp1k1mod r
+ tc1=tc1r                     tc2=tc2r
