...
*
.subckt rm5 n1_enh n2_enh w=10e-6 l=10e-6 r=1 par1=1 
xocc_m1 n1_enh n2_enh n1 n2  rm5_ahdl tstep_occ=tstep_soac w=w maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param rsh_i='rm5_rsh'
.param dw_i='rm5_dw'
