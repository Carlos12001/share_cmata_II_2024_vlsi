...
* Simulator : HSPICE
* Device    : rpp1nw_3
* Desc      : P-doped POLY1 resistor (non-salicided, underlying NWELL), 3 terminals
...
*            3) pm=n  : n contacts
*
.subckt rpp1nw_3 n1 n2 nb l=10e-6 w=10e-6 pm=-1 par1=1
.param pmc='max(1,1+int((w-4.200e-07)/4.700e-07))'
+ pmi='(pm>=0)?((pm==0)?1000:pm):pmc'
+ rsh='rpp1nw_rsh'
+ weff='w-(rpp1nw_dw*2)'
+ mf='1+rpp1nw_ar/sqrt(1e12*par1*weff*l)'
+ r0='mf*rsh*l/weff'
...
r1 na nc rpp1nw_3mod r='r0*(1+v(101))/2'
+ l='l/2' w=w
r2 nc nd rpp1nw_3mod r='r0*(1+v(101))/2'
+ l='l/2' w=w
.model rpp1nw_3mod r
+ tc1=tc1r                     tc2=tc2r
