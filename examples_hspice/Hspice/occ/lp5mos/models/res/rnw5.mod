...
*            3) pm=n  : n contacts
*
.subckt rnw5 n1 n2 nb l=10e-6 w=10e-6 xf_subext=0 pm=-1 par1=1 
xocc_m1 n1 n2 nb  rnw5_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
r1 na nc rnw5mod r='r0*(1+v(101))/2'
+ l='l/2' w=w
r2 nc nd rnw5mod r='r0*(1+v(101))/2'
+ l='l/2' w=w
.model rnw5mod r
+ tc1=tc1r                     tc2=tc2r
