...
* Simulator : HSPICE
* Device    : rnp1_3
* Desc      : N-doped POLY1 resistor (non-salicided, underlying NWELL/PWELL2), 3 terminals
...
*
.subckt rnp1_3 n1_enh n2_enh nb_enh l=10e-6 w=10e-6 pm=-1 par1=1 
xocc_m1 n1_enh n2_enh nb_enh n1 n2 nb  rnp1_3_ahdl tstep_occ=tstep_soac w=w maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param pmc='max(1,1+int((w-4.200e-07)/4.700e-07))'
+ pmi='(pm>=0)?((pm==0)?1000:pm):pmc'
+ rsh='rnp1_3_rsh'
+ weff='w-(rnp1_3_dw*2)'
+ mf='1+rnp1_3_ar/sqrt(1e12*par1*weff*l)'
+ r0='mf*rsh*l/weff'
+ tc1r='-2.8333e-06*rsh-5.7667e-04'
...
r1 na nc rnp1_3mod r='r0*(1+v(101))/2'
+ l='l/2' w=w
r2 nc nd rnp1_3mod r='r0*(1+v(101))/2'
+ l='l/2' w=w
.model rnp1_3mod r
+ tc1=tc1r                     tc2=tc2r
