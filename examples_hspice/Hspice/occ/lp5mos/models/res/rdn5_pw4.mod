...
* Simulator : HSPICE
* Device    : rdn5_pw4
* Desc      : NDIFF drain ballast resistor of ESD NMOS (PWELL4 in PWELL2)
...
*            3) pm=n  : n contacts
*
.subckt rdn5_pw4 n1 n2 nb l=10e-6 w=10e-6 xf_subext=0 pm=-1 par1=1
...
r1 na nc rdn5_pw4mod r='r0/2'
+ l='l/2' w=w
r2 nc nd rdn5_pw4mod r='r0/2'
+ l='l/2' w=w
.model rdn5_pw4mod r
+ tc1=tc1r                     tc2=tc2r
