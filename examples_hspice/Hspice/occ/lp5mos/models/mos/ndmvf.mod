...
*            par1 = m = multiplier
*
.subckt ndmvf d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  ndmvf_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
+ mm_rdrmue='ndmvf_rdrmue_mm*6.000e-02/sqrt(par1*1e12*(w+8.000000e-06)*l)'
xddb b d dfwdnf area=adl perimeter=pdl m_soa=par1
rb1 b1 b r=1e-02
rbs b1 s r='extlay==0?1e-02:1e12'
.if ( extlay==0 && xf_subext==0 )
cbox b sub c='3.45e-5*(w+1e-6)*(l+(6.54e-6/2-0.7e-06))'
.endif
m1 d g s b1 sub ndmvfmod w='w' l='l+0.4e-06'
+ ad=0 as=0 pd=0 ps=0 nrd=0 nrs=0
+ coselfheat='coselfheat?2:0'
xm2 d g s b1 ndmvf_mos2 l='l+0.4e-06' w='w'
...
+ cgbo=0                        lcgbo=0
+ wcgbo=0                       pcgbo=0
+ rth0='7.33508+0.03679*(temper-27)' lrth0='12.46936+0.03679*(temper-27)'
+ wrth0=-15                     prth0=0
+ powrat=1                      lpowrat=0
+ wpowrat=0                     ppowrat=0
+ rdvd=0.07                     lrdvd=0
...
+ vmax='1.000e+00*(13.45E+06)'            lvmax='1.000e+00*(0)'
+ wvmax='1.000e+00*(0)'         pvmax='1.000e+00*(0)'
+ vmaxt1=0.000e+00
+ vmaxt2=0.000e+00
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='ndmvf_vfbc*(-2.354)'              lvfbc='ndmvf_vfbc*(-0.3831)'
+ wvfbc='ndmvf_vfbc*(0)'        pvfbc='ndmvf_vfbc*(0)'
+ vbi=1.100e+00
+ nsubc='ndmvf_nsubc_m*(5.66E+16)'        lnsubc='ndmvf_nsubc_m*(4.436E+15)'
+ wnsubc='ndmvf_nsubc_m*(0)'    pnsubc='ndmvf_nsubc_m*(0)'
+ parl2=1.000e-08
+ lp=1.655e-07
...
+ ninv=0.5045                   lninv=0
+ wninv=0                       pninv=0
+ muecb0=43                     lmuecb0=24
+ wmuecb0=0                     pmuecb0=0
+ muecb1=7.019                  lmuecb1=0
+ wmuecb1=0                     pmuecb1=0
+ mueph0=3.000e-01
+ mueph1=34570                  lmueph1=0
+ wmueph1=0                     pmueph1=0
+ muephw=0.000e+00
+ muepwp=1.000e+00
+ muephl=-4.800e-01
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(ndmvf_rdrmue)'  
+ rdrvmax='ndmvf_rdrvmax'
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
+ rdrmuetmp='0.00715*(temper-27)+1.00832'
