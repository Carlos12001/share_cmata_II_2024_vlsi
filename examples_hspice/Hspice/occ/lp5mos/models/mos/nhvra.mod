...
*            par1 = m = multiplier
*
.subckt nhvra d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  nhvra_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param adl='(ad>=0)?ad:(2.56e-06*w)'
...
xddb b d dfwdnha area=adl perimeter=pdl m_soa=par1
rb1 b1 b r=1e-02
rbs b1 s r='extlay==0?1e-02:1e12'
.if ( extlay==0 && xf_subext==0 )
cbox b sub c='3.45e-5*(w+1e-6)*(l+(7.4e-6/2-0.4e-06))'
.endif
m1 d g s b1 sub nhvramod w='w' l='l+0.85e-06'
...
+ wnpext=0
+ vover=0.8068                  lvover=0
+ wvover=0                      pvover=0
+ falph=0.9002                  lfalph=0
+ wfalph=0                      pfalph=0
+ cgbo=0                        lcgbo=0
+ rth0=3.6                      lrth0=6.7
+ wrth0=-5                      prth0=-13.5
...
+ vmax='nhvra_vmax_m*(1E+06)'             lvmax='nhvra_vmax_m*(4.000E+06)'
+ wvmax='nhvra_vmax_m*(0)'      pvmax='nhvra_vmax_m*(0)'
+ vmaxt1=-1.037e-03
+ vmaxt2=0.000e+00
+ bgtmp1=9.025E-05              
+ bgtmp2=1.025E-08              lbgtmp2=-4.317E-07
+ wbgtmp2=0                     pbgtmp2=0
+ eg0=1.132                     
+ tox='nhvra_tox'
+ xld=3.000e-08
...
+ wvfbover=0
+ nover=5.499E+16               lnover=0
+ wnover=1.528E+16              pnover=0
+ novers=1.879E+17              
+ wnovers=0
+ olmdlt=5.000e+00
+ xwd=0.000e+00
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='mm_vfbc+nhvra_vfbc_m*(-1.165)'   
+ lvfbc='nhvra_vfbc_m*(0.17)'            
+ wvfbc='nhvra_vfbc_m*(0)'               
+ pvfbc='nhvra_vfbc_m*(-0.05)'           
+ vbi=1.100e+00
+ nsubc='nhvra_nsubc_m*(3.225E+17)'       lnsubc='nhvra_nsubc_m*(-2.273E+17)'
+ wnsubc='nhvra_nsubc_m*(0)'    pnsubc='nhvra_nsubc_m*(0)'
+ parl2=1.000e-08
+ lp=3.638e-08
...
+ ninv=0.34                     lninv=0.2
+ wninv=0                       pninv=0
+ muecb0=100000                 lmuecb0=0
+ wmuecb0=-3000                 pmuecb0=0
+ muecb1=4269                   lmuecb1=0
+ wmuecb1=541.7                 pmuecb1=-385.9
+ mueph0=2.969e-01
+ mueph1='(1+mm_mueph1)*nhvra_mueph1_m*(19400)'
+ lmueph1='nhvra_mueph1_m*(0)'           
+ wmueph1='nhvra_mueph1_m*(0)'           
+ pmueph1='nhvra_mueph1_m*(0)'           
+ muephw=-8.000e-02
+ muepwp=1.000e+00
+ muephl=-7.717e-01
+ mueplp=8.598e-01
...
+ wvth0=0                       
+ muesr0=2.070e+00
+ muesr1=6E+14                  lmuesr1=0
+ wmuesr1=0                     pmuesr1=0
+ muesrl=-3.913e-02
+ muesrw=-4.411e-02
+ mueswp=1.000e+00
+ mueslp=8.297e-01
+ muetmp=1.8                    lmuetmp=-0.7258
+ bb=2.000e+00
+ sub1=0.002018                 
+ sub2=58.99                    
+ svgs=1.426                    
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(nhvra_rdrmue)'  
+ rdrvmax='nhvra_rdrvmax'
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
+ rdrmuetmp='1.616*(1+4E-03*(temper-27)-25E-06*(temper-27)*(temper-27))'
