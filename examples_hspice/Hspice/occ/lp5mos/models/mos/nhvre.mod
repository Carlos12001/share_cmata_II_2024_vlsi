...
*            par1 = m = multiplier
*
.subckt nhvre d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  nhvre_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
+ vmax='nhvre_vmax_m*(1.8E+06)'           lvmax='nhvre_vmax_m*(6.255E+06)'
+ wvmax='nhvre_vmax_m*(0)'      pvmax='nhvre_vmax_m*(0)'
+ vmaxt1=-1.037e-03
+ vmaxt2=0.000e+00
+ bgtmp1=9.025E-05              
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='mm_vfbc+nhvre_vfbc_m*(-1.166)'   
+ lvfbc='nhvre_vfbc_m*(0.008972)'        
+ wvfbc='nhvre_vfbc_m*(-0.04)'           
+ pvfbc='nhvre_vfbc_m*(0.1)'             
+ vbi=1.100e+00
+ nsubc='nhvre_nsubc_m*(4.148E+17)'       lnsubc='nhvre_nsubc_m*(-1.656E+17)'
+ wnsubc='nhvre_nsubc_m*(0)'    pnsubc='nhvre_nsubc_m*(0)'
+ parl2=1.000e-08
+ lp=4.943e-08
...
+ mueph0=2.969e-01
+ mueph1='(1+mm_mueph1)*nhvre_mueph1_m*(18500)'
+ lmueph1='nhvre_mueph1_m*(0)'           
+ wmueph1='nhvre_mueph1_m*(0)'           
+ pmueph1='nhvre_mueph1_m*(0)'           
+ muephw=-8.000e-02
+ muepwp=1.000e+00
+ muephl=-7.691e-01
+ mueplp=8.598e-01
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(nhvre_rdrmue)'  
+ rdrvmax='nhvre_rdrvmax'
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
