...
*            par1 = m = multiplier
*
.subckt phvrb d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  phvrb_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
xddb d b dfwdphb area=adl perimeter=pdl m_soa=par1
rb1 b1 b r=1e-02
rbs b1 s r='extlay==0?1e-02:1e12'
.if ( extlay==0 && xf_subext==0 )
cbox b sub c='3.45e-5*(w+1e-6)*(l+(9.8e-6/2-0.5e-06))'
.endif
m1 d g s b1 sub phvrbmod w=w l='l+0.85e-6'
...
+ rdvb=0                        
+ cvdsover=0                    
+ vmax='phvrb_vmax_mul*(9E+06)'           
+ pvmax='phvrb_vmax_mul*(1E+08)'
+ vmaxt1=0.000e+00
+ vmaxt2=0.000e+00
+ bgtmp1=9.025E-05              
+ bgtmp2=1E-07                  
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='mm_vfbc+phvrb_vfbc_mul*(-1.11)'  
+ lvfbc='phvrb_vfbc_mul*(-0.021)'        
+ wvfbc=0.000e+00                        
+ pvfbc=0.000e+00                        
+ vbi=1.100e+00
+ nsubc='phvrb_nsubc_mul*(2.9986E+17)'    
+ parl2=1.000e-08
+ lp=2.400e-08
+ nsubp=9.6521E+18              
+ nsubp0=1.350e-01
...
+ muecb1=1587.5                 
+ mueph0=3.000e-01
+ mueph1='(1+mm_mueph1)*phvrb_mueph1_mul*(7050)'
+ lmueph1=0.000e+00                      
+ wmueph1=0.000e+00                      
+ pmueph1=0.000e+00                      
+ muephw=2.000e-01
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(phvrb_rdrmue)'  
+ rdrvmax='phvrb_rdrvmax'
+ rdrmues=1.000e+02
+ rdrvmaxs=3.000e+07
+ rdrmuetmp=1.674e+00
