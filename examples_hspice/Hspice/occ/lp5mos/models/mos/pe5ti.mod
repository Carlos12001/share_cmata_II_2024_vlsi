...
*
.subckt pe5ti d g s b w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ xf_subext=0 par1=1 sa=-1 sb=-1 sd=-1 sca=-1 scb=-1 scc=-1
xocc_m1 d g s b  pe5ti_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
+ scbl='(scb>0)?scb:0'
+ sccl='(scc>0)?scc:0'
+ mfvt='5.077e-03/sqrt(par1*1e12*(w+0.000e+00)*(l+0.000e+00))'
+ mfu0='5.374e-03/sqrt(par1*1e12*(w+0.000e+00)*(l+0.000e+00))'
*
.if ( xf_subext==0 )
m1 d g s b pe5timod w=w l=l ad=adl as=asl pd=pdl ps=psl nrd=nrdl nrs=nrsl
+ sa=sal sb=sbl sd=sdl
+ sca=scal scb=scbl scc=sccl
+ delvto='pe5_vtmm*mfvt'
+ mulu0='(1+(pe5_u0mm*mfu0))*pe5ti_u0_mul'
.elseif ( xf_subext==1 )
m1 d g s b pe5timod w=w l=l ad=1e-15 as=1e-15 pd=0 ps=0 nrd=0 nrs=0
+ sa=sal sb=sbl sd=sdl
+ sca=scal scb=scbl scc=sccl
+ delvto='pe5_vtmm*mfvt'
+ mulu0='(1+(pe5_u0mm*mfu0))*pe5ti_u0_mul'
...
+ vth0='-0.7633+pe5ti_vth0_add'
+ lvth0='5.87E-08+(2.980e-07*pe5ti_vth0_add)'
+ wvth0='-2.068E-08+(2.000e-07*pe5ti_vth0_add)'
+ pvth0=9.3E-16
+ vfb=-1                        
+ vddeot=1.500e+00
+ phin=0.1                      
...
+ lp=1E-08                      
+ eu=1                          
+ vsat='pe5ti_vsat_mul*(110000)'          lvsat='pe5ti_vsat_mul*(0.001361)'
+ wvsat='pe5ti_vsat_mul*(0)'    pvsat='pe5ti_vsat_mul*(0.98E-08)'
+ lambda=0                      
+ vtl=200000                    
+ lc=5.000e-09
+ xn=3                          
...
+ rdsw='pe5ti_rdsw_mul*(442)'             lrdsw='pe5ti_rdsw_mul*(0)'
+ wrdsw='pe5ti_rdsw_mul*(0)'    prdsw='pe5ti_rdsw_mul*(0)'
+ rdswmin=1.000e-12
+ rdw=100                       
+ rdwmin=0.000e+00
+ rsw=100                       
...
+ wuc1=0                        puc1=5E-15
+ ud1=0                         
+ at='pe5ti_vsat_mul*(1.95E+05)'          lat='pe5ti_vsat_mul*(-0.09)'
+ wat='pe5ti_vsat_mul*(0.005)'  pat='pe5ti_vsat_mul*(-4E-08)'
+ prt=0                         
