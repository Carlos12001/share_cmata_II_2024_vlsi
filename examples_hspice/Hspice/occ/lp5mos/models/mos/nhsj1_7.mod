...
* Simulator : HSPICE
* Device    : nhsj1_7
* Desc      : 100V (7µm) HV NMOS
* Model     : HiSIM_HV 5t-subckt
*           : hspice.hisimhv_stripe.nmos.5term_hvmos5.1621
* Process   : XT018
* Extracted : XT018 Wafer: M50373_w12; Date: 2015-01-23; hwald
* Spec.     : PDS_018_06
...
*            par1 = m = multiplier
*
.subckt nhsj1_7 d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  nhsj1_7_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param adl='(ad>=0)?ad:((w+0e-06)*7e-06)'
+ asl='(as>=0)?as:((0.52e-06*w))'
+ pdl='(pd>=0)?pd:(2*(w+0e-06))'
+ psl='(ps>=0)?ps:(2*(w+0.52e-06))'
+ nrdl='(nrd>=0)?nrd:(0)'
+ nrsl='(nrs>=0)?nrs:(0.27e-6/w)'
+ mm_vfbc='nhsj1_7_vfbc_mm*1.200e-02/sqrt(par1*1e12*w*(l+1.500000e-06))'
+ mm_mueph1='nhsj1_7_mueph1_mm*9.190e-03/sqrt(par1*1e12*w*(l+1.500000e-06))'
+ mm_rdrmue='nhsj1_7_rdrmue_mm*5.660e-03/sqrt(par1*1e12*w*(l+1.500000e-06))'
xddb b d dfwnsj1_7 area=adl perimeter=pdl m_soa=par1
xdsb b s dn5 area=asl perimeter=psl m_soa=par1
m1 d g s b sub nhsj1_7mod w='w+0e-06' l='l+1.5e-6'
+ ad=0 as=0 pd=0 ps=0 nrd=0 nrs=0
+ coselfheat='coselfheat?1:0'
.model nhsj1_7mod nmos
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='mm_vfbc+(-1.103)'                 lvfbc=0.2846
+ wvfbc=0                       pvfbc=0
+ vbi=1.200e+00
+ nsubc='nhsj1_7_nsubc_m*(3.444E+17)'     lnsubc='nhsj1_7_nsubc_m*(-7E+16)'
+ wnsubc='nhsj1_7_nsubc_m*(0)'  pnsubc='nhsj1_7_nsubc_m*(0)'
+ parl2=1.000e-08
+ lp=1.106e-07
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(nhsj1_7_rdrmue)'
+ rdrvmax='nhsj1_7_rdrvmax'
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
+ rdrmuetmp=1.838e+00
