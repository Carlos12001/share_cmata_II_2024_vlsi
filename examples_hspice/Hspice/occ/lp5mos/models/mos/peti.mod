...
*
.subckt peti d g s b w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ xf_subext=0 par1=1 sa=-1 sb=-1 sd=-1 sca=-1 scb=-1 scc=-1
xocc_m1 d g s b  peti_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
+ scbl='(scb>0)?scb:0'
+ sccl='(scc>0)?scc:0'
+ mfvt='3.825e-03/sqrt(par1*1e12*(w+0.000e+00)*(l+0.000e+00))'
+ mfu0='6.647e-03/sqrt(par1*1e12*(w+0.000e+00)*(l+0.000e+00))'
*
.if ( xf_subext==0 )
m1 d g s b petimod w=w l=l ad=adl as=asl pd=pdl ps=psl nrd=nrdl nrs=nrsl
+ sa=sal sb=sbl sd=sdl
+ sca=scal scb=scbl scc=sccl
+ delvto='pe_vtmm*mfvt'
+ mulu0='(1+(pe_u0mm*mfu0))*pe_u0_mul'
.elseif ( xf_subext==1 )
m1 d g s b petimod w=w l=l ad=1e-15 as=1e-15 pd=0 ps=0 nrd=0 nrs=0
+ sa=sal sb=sbl sd=sdl
+ sca=scal scb=scbl scc=sccl
+ delvto='pe_vtmm*mfvt'
+ mulu0='(1+(pe_u0mm*mfu0))*pe_u0_mul'
...
+ vth0='-0.6404+peti_vth0_add'
+ lvth0='7.4665E-08+(-1.350e-07*peti_vth0_add)'
+ wvth0='-2.427E-08+(1.460e-07*peti_vth0_add)'
+ pvth0='7.65E-16+(9.700e-15*peti_vth0_add)'
+ vfb=-1                        
+ vddeot=-1.500e+00
+ phin=0                        
...
+ lp=1E-08                      
+ eu=1                          
+ vsat='peti_vsat_mul*(96900)'            lvsat='peti_vsat_mul*(0)'
+ wvsat='peti_vsat_mul*(0)'     pvsat='peti_vsat_mul*(1.4E-08)'
+ lambda=1E-09                  
+ vtl=200000                    
+ lc=5.000e-09
+ xn=3                          
...
+ tvoff=0                       
+ minv=-0.1807                  
+ nfactor='peti_nfactor_mul*(1.053)'      lnfactor='peti_nfactor_mul*(0)'
+ wnfactor='peti_nfactor_mul*(0)' pnfactor='peti_nfactor_mul*(0)'
+ tnfactor=0                    
+ eta0=0.9547                   
+ teta0=0                       
+ etab=-2                       
...
+ rdsw='peti_rdsw_mul*(127.5)'            lrdsw='peti_rdsw_mul*(0)'
+ wrdsw='peti_rdsw_mul*(0)'     prdsw='peti_rdsw_mul*(0)'
+ rdswmin=1.000e+00
+ rdw=100                       
+ rdwmin=0.000e+00
+ rsw=100                       
