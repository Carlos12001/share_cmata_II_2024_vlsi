...
* Simulator : HSPICE
* Device    : ndmvf_mos2
* Desc      : parallel mos for 32V depletion HVNMOS
...
*            par1 == m = multiplier
*
.subckt ndmvf_mos2 d g s b w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1
...
*
.if ( xf_subext==0 )
m1 d g s b ndmvf_mos2mod w=w l=l ad=adl as=asl pd=pdl ps=psl nrd=nrdl nrs=nrsl
+ delvto='(ndmvf_mos2_avt+wcd_avt)/sqrt(par1*1e12*(w+6.000e-06)*(l+5.000e-07))'
+ mulu0='1+(ndmvf_mos2_au0+wcd_au0)/sqrt(par1*1e12*(w+1.000e-05)*(l+5.000e-07))'
.elseif ( xf_subext==1 )
m1 d g s b ndmvf_mos2mod w=w l=l ad=1e-15 as=1e-15 pd=0 ps=0 nrd=0 nrs=0
+ delvto='(ndmvf_mos2_avt+wcd_avt)/sqrt(par1*1e12*(w+6.000e-06)*(l+5.000e-07))'
+ mulu0='1+(ndmvf_mos2_au0+wcd_au0)/sqrt(par1*1e12*(w+1.000e-05)*(l+5.000e-07))'
.endif
.model ndmvf_mos2mod nmos
+ apwarn=0
...
+ vth0='-1.761+ndmvf_mos2_vth0_d'
+ lvth0='0.349+(2.400e-01*ndmvf_mos2_vth0_d)'
+ wvth0=0.62
+ pvth0=-0.2
+ k1=1.589                      
+ k2=-0.1                       
...
+ dvt1w=5.3E+06                 
+ dvt2w=-0.032                  
+ u0='ndmvf_mos2_u0_m*(118)'              lu0='ndmvf_mos2_u0_m*(9)'
+ wu0='ndmvf_mos2_u0_m*(15)'    pu0='ndmvf_mos2_u0_m*(0)'
...
+ alpha0=0                      
+ beta0=0                       
+ pclm='max(0.01,min(15,-0.35942+4.79558*exp((-1)*(temper-27)/72.15285)))' lpclm=0
+ wpclm=0                       ppclm=0
...
+ drout=0.56                    
+ pvag=2.965                    
+ pscbe1=2E+09                  lpscbe1=0
+ wpscbe1=0                     ppscbe1=0
+ pscbe2=1E-07                  lpscbe2=0
+ wpscbe2=0                     ppscbe2=0
+ delta=0.01                    ldelta=0
+ wdelta=0                      pdelta=0
...
+ ef=1
+ af=1                         kf=1.50E-29
+ noia=1.026E+20               noib=2.8E05                    noic=-8.03E-11
+ acm=13                       nj=1                           xpart=0
+ rsh=0                        js=0                           jsw=0
+ cgdo=1.000e-12
+ cgdl=0.000e+00
