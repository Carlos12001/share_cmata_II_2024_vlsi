...
* Spec.     : PS_018_06
* ----------------------------------------------------------------------
*             WORST CASE POWER CONDITION ( Fast NMOS Fast PMOS ) 
* ----------------------------------------------------------------------
*
.param
*ne - 10.0.1; 2020-05-11
+ne_toxe=max(3.900e-09,4.100e-09-(xsf__mos*3.333e-11))
...
+ne_xl=max(-6.000e-09,0.000e+00-(xsf__mos*1.000e-09))
+ne_xw=min(6.000e-09,0.000e+00+(xsf__mos*1.000e-09))
+ne_cgdo=max(1.827e-10,2.284e-10-(xsf__mos*7.613e-12))
+ne_cgdl=max(1.126e-10,1.407e-10-(xsf__mos*4.690e-12))
+ne_cgso=max(1.827e-10,2.284e-10-(xsf__mos*7.613e-12))
+ne_cgsl=max(1.126e-10,1.407e-10-(xsf__mos*4.690e-12))
+ne_vtmm=0.000e+00
+ne_u0mm=0.000e+00
*pe - 10.0.1; 2020-05-11
+pe_toxe=max(3.700e-09,3.900e-09-(xsf__mos*3.333e-11))
...
+pe_xl=max(-1.200e-08,0.000e+00-(xsf__mos*2.000e-09))
+pe_xw=min(6.000e-09,0.000e+00+(xsf__mos*1.000e-09))
+pe_rdsw_mul=max(5.000e-01,1.000e+00-(xsf__mos*8.333e-02))
+pe_cgo_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+pe_cgl_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+pe_vtmm=0.000e+00
+pe_u0mm=0.000e+00
*nn - 10.0.1; 2020-05-11
+nn_toxe=max(3.700e-09,4.100e-09-(xsf__mos*6.667e-11))
...
+nn_xl=max(-6.000e-09,0.000e+00-(xsf__mos*1.000e-09))
+nn_xw=min(1.200e-08,0.000e+00+(xsf__mos*2.000e-09))
+nn_rdsw_m=max(9.100e-01,1.000e+00-(xsf__mos*1.500e-02))
+nn_cgdo=max(2.078e-10,2.591e-10-(xsf__mos*8.550e-12))
+nn_cgdl=max(8.020e-11,1.000e-10-(xsf__mos*3.300e-12))
+nn_cgso=max(2.078e-10,2.591e-10-(xsf__mos*8.550e-12))
+nn_cgsl=max(8.020e-11,1.000e-10-(xsf__mos*3.300e-12))
+nn_cs_f_mul=max(7.330e-01,1.000e+00-(xsf__mos*4.450e-02))
+nn_vtmm=0.000e+00
+nn_u0mm=0.000e+00
...
+nel_toxe=max(3.900e-09,4.100e-09-(xsf__mos*3.330e-11))
...
+nel_xl=max(-6.000e-09,0.000e+00-(xsf__mos*1.000e-09))
+nel_xw=min(6.000e-09,0.000e+00+(xsf__mos*1.000e-09))
+nel_cg_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+nel_vtmm=0.000e+00
+nel_u0mm=0.000e+00
...
+pel_toxe=max(3.700e-09,3.900e-09-(xsf__mos*3.330e-11))
...
+pel_xl=max(-6.000e-09,0.000e+00-(xsf__mos*1.000e-09))
+pel_xw=min(6.000e-09,0.000e+00+(xsf__mos*1.000e-09))
+pel_cg_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+pel_vtmm=0.000e+00
+pel_u0mm=0.000e+00
...
+peti_rdsw_mul=max(4.080e-01,1.000e+00-(xsf__mos*9.867e-02))
*nesvt - 10.0.1; 2020-05-11
+nesvt_toxe=max(3.900e-09,4.100e-09-(xsf__mos*3.330e-11))
...
+nesvt_xl=max(-6.000e-09,0.000e+00-(xsf__mos*1.000e-09))
+nesvt_xw=min(6.000e-09,0.000e+00+(xsf__mos*1.000e-09))
+nesvt_cgo_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+nesvt_cgl_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+nesvt_vtmm=0.000e+00
+nesvt_u0mm=0.000e+00
*pesvt - 12.0.1; 2022-12-21
+pesvt_toxe=max(3.700e-09,3.900e-09-(xsf__mos*3.330e-11))
...
+pesvt_xl=max(-1.200e-08,0.000e+00-(xsf__mos*2.000e-09))
+pesvt_xw=min(6.000e-09,0.000e+00+(xsf__mos*1.000e-09))
+pesvt_rdsw_mul=max(5.000e-01,1.000e+00-(xsf__mos*8.333e-02))
+pesvt_cgo_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+pesvt_cgl_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+pesvt_vtmm=0.000e+00
+pesvt_u0mm=0.000e+00
*ne5 - 12.0.1; 2022-12-21
+ne5_toxe=max(1.220e-08,1.270e-08-(xsf__mos*8.333e-11))
+ne5_u0_m=min(1.018e+00,1.000e+00+(xsf__mos*3.000e-03))
+ne5_nfactor_m=min(1.400e+00,1.000e+00+(xsf__mos*6.667e-02))
+ne5_k1_m=max(9.500e-01,1.000e+00-(xsf__mos*8.333e-03))
+ne5_vth0_d=max(-3.816e-02,0.000e+00-(xsf__mos*6.360e-03))
+ne5_vsat_m=min(1.025e+00,1.000e+00+(xsf__mos*4.200e-03))
+ne5_xl=max(-1.200e-08,0.000e+00-(xsf__mos*2.000e-09))
+ne5_xw=min(2.000e-08,0.000e+00+(xsf__mos*3.333e-09))
+ne5_rdsw_m=max(9.000e-01,1.000e+00-(xsf__mos*1.667e-02))
+ne5_cgdo=max(8.934e-11,1.114e-10-(xsf__mos*3.676e-12))
+ne5_cgdl=max(7.723e-11,9.630e-11-(xsf__mos*3.178e-12))
+ne5_cgso=max(8.934e-11,1.114e-10-(xsf__mos*3.676e-12))
+ne5_cgsl=max(7.723e-11,9.630e-11-(xsf__mos*3.178e-12))
+ne5_vtmm=0.000e+00
+ne5_u0mm=0.000e+00
*pe5 - 12.0.1; 2022-12-21
+pe5_toxe=max(1.220e-08,1.270e-08-(xsf__mos*8.333e-11))
...
+pe5_xl=max(-6.000e-09,0.000e+00-(xsf__mos*1.000e-09))
+pe5_xw=min(2.000e-08,0.000e+00+(xsf__mos*3.333e-09))
+pe5_rdsw_m=max(5.000e-01,1.000e+00-(xsf__mos*8.333e-02))
+pe5_cgo_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+pe5_cgl_m=max(8.000e-01,1.000e+00-(xsf__mos*3.333e-02))
+pe5_vtmm=0.000e+00
+pe5_u0mm=0.000e+00
*nn5 - 10.0.1; 2020-05-11
+nn5_toxe=max(1.170e-08,1.270e-08-(xsf__mos*1.666e-10))
...
+nn5_xl=max(-1.200e-08,0.000e+00-(xsf__mos*2.000e-09))
+nn5_xw=min(6.000e-09,0.000e+00+(xsf__mos*1.000e-09))
+nn5_cgdo=max(8.822e-11,1.100e-10-(xsf__mos*3.630e-12))
+nn5_cgdl=max(9.568e-11,1.193e-10-(xsf__mos*3.937e-12))
+nn5_cgso=max(8.822e-11,1.100e-10-(xsf__mos*3.630e-12))
+nn5_cgsl=max(9.568e-11,1.193e-10-(xsf__mos*3.937e-12))
+nn5_cs_f_m=max(4.000e-01,1.000e+00-(xsf__mos*1.000e-01))
+nn5_vtmm=0.000e+00
+nn5_u0mm=0.000e+00
...
+pe5ti_rdsw_mul=max(9.000e-01,1.000e+00-(xsf__mos*1.667e-02))
*nd5 - 10.0.3; 2021-05-12
+nd5_avt=0.000e+00
+nd5_au0=0.000e+00
*nd5_mos1 - 10.0.3; 2021-05-12
+nd5_mos1_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.666e-10))
+nd5_mos1_vth0_d=max(-8.700e-03,0.000e+00-(xsf__mos*1.450e-03))
+nd5_mos1_xl=max(-1.200e-08,0.000e+00-(xsf__mos*2.000e-09))
+nd5_mos1_xw=min(6.000e-09,0.000e+00+(xsf__mos*1.000e-09))
+nd5_mos1_rdsw=max(1.353e+03,1.487e+03-(xsf__mos*2.231e+01))
*nd5_mos2 - 10.0.3; 2021-05-12
+nd5_mos2_rdsw=max(7.303e+02,8.025e+02-(xsf__mos*1.204e+01))
*nmvaa - 12.0.1; 2022-12-21
+nmvaa_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nmvab_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nmvb_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nmvc_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nmvd_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+ndmvd_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nmve_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nmvf_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+ndmvf_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+pmvaa_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+pmvab_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+pmvb_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+pmvd_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+pmve_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+pmvf_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhvta_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.666e-10))
...
+ndhvta_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.666e-10))
...
+nhvtb_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.666e-10))
...
+ndhvt_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+ndhvt_xw=min(2.000e-08,0.000e+00+(xsf__mos*3.333e-09))
*nhvu - 11.1.2; 2022-01-31
+nhvu_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.666e-10))
...
+phvta_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.666e-10))
...
+phvtb_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phvu_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhvra_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhvrb_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhvrc_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhvrd_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+ndhvrd_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.660e-10))
...
+nhvre_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhvrf_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+ndhvrf_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.660e-10))
...
+phvra_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phvrb_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phvrc_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phvrd_tox=max(1.162e-08,1.262e-08-(xsf__mos*1.667e-10))
...
+phvre_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phvrf_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhsj1_7_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhsj1_10_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhsj1_16c_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phsj1_7_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phsj1_10_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phsj1_16c_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nisj1_16_doisme=min(1.466e+01,0.000e+00+(xsf__mos*2.444e+00))
+nisj1_16_dprs=max(1.000e+02,1.157e+04-(xsf__mos*2.192e+03))
*nisj1_16_m1 - 12.0.1; 2022-12-21
+nisj1_16_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nisj1_16_dis=min(4.015e-01,0.000e+00+(xsf__mos*6.692e-02))
+nisj1_16_dbf=min(1.113e+00,1.000e+00+(xsf__mos*1.889e-02))
+nisj1_16_dikf=min(3.015e+00,0.000e+00+(xsf__mos*5.025e-01))
+nisj1_16_dcje=max(8.020e-01,1.000e+00-(xsf__mos*3.300e-02))
+nisj1_16_dcjc=max(8.020e-01,1.000e+00-(xsf__mos*3.300e-02))
+nisj1_16_dtf=max(4.600e-01,1.000e+00-(xsf__mos*9.000e-02))
*nhsj1b_2 - 12.0.1; 2022-12-21
+nhsj1b_2_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhsj1b_4_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhsj1b_4_xw=min(2.000e-08,0.000e+00+(xsf__mos*3.333e-09))
+nhsj1b_4_mueph1_mm=0.000e+00
+nhsj1b_4_rdrmue_mm=0.000e+00
+nhsj1b_4_vfbc_mm=0.000e+00
*nhsj1b_5 - 12.0.1; 2022-12-21
+nhsj1b_5_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhsj1b_7_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhsj1b_8_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhsj1b_10_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+nhsj1a_13_tox=max(1.198e-08,1.270e-08-(xsf__mos*1.200e-10))
...
+phsj1a_4_xw=min(6.000e-08,0.000e+00+(xsf__mos*1.000e-08))
+phsj1a_4_mueph1_mm=0.000e+00
+phsj1a_4_rdrmue_mm=0.000e+00
+phsj1a_4_vfbc_mm=0.000e+00
*phsj1a_5 - 12.0.1; 2022-12-21
+phsj1a_5_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phsj1a_5_xw=min(6.000e-08,0.000e+00+(xsf__mos*1.000e-08))
+phsj1a_5_mueph1_mm=0.000e+00
+phsj1a_5_rdrmue_mm=0.000e+00
+phsj1a_5_vfbc_mm=0.000e+00
*phsj1a_7 - 12.0.1; 2022-12-21
+phsj1a_7_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phsj1a_7_xw=min(6.000e-08,0.000e+00+(xsf__mos*1.000e-08))
+phsj1a_7_mueph1_mm=0.000e+00
+phsj1a_7_rdrmue_mm=0.000e+00
+phsj1a_7_vfbc_mm=0.000e+00
*phsj1a_8 - 12.0.1; 2022-11-21
+phsj1a_8_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phsj1a_8_xw=min(6.000e-08,0.000e+00+(xsf__mos*1.000e-08))
+phsj1a_8_mueph1_mm=0.000e+00
+phsj1a_8_rdrmue_mm=0.000e+00
+phsj1a_8_vfbc_mm=0.000e+00
*phsj1a_10 - 12.0.1; 2022-12-21
+phsj1a_10_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phsj2b_7_xw=min(2.000e-08,0.000e+00+(xsf__mos*3.333e-09))
+phsj2b_7_mueph1_mm=0.000e+00
+phsj2b_7_rdrmue_mm=0.000e+00
+phsj2b_7_vfbc_mm=0.000e+00
*phsj2b_8 - 11.0.1; 2021-10-20
+phsj2b_8_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phsj2b_8_xw=min(2.000e-08,0.000e+00+(xsf__mos*3.333e-09))
+phsj2b_8_mueph1_mm=0.000e+00
+phsj2b_8_rdrmue_mm=0.000e+00
+phsj2b_8_vfbc_mm=0.000e+00
*phsj2b_10 - 11.0.1; 2021-10-20
+phsj2b_10_tox=max(1.170e-08,1.270e-08-(xsf__mos*1.667e-10))
...
+phsj2b_16_xw=min(2.000e-08,0.000e+00+(xsf__mos*3.333e-09))
