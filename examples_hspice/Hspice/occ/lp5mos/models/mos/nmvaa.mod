...
* Process   : XT018
* Extracted : S59545_w6; Date: 2022-01-31; jge
* Spec.     : PDS_018_06
...
*
.subckt nmvaa d g s b w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b  nmvaa_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param adl='(ad>=0)?ad:(0.91e-6*(w+2*0.5e-6))'
+ asl='(as>=0)?as:(0.32e-6*w)'
+ pdl='(pd>=0)?pd:(w+2*0.5e-6)'
+ psl='(ps>=0)?ps:(2*(w+0.32e-6))'
+ nrdl='(nrd>=0)?nrd:(0.2e-6/w)'
+ nrsl='(nrs>=0)?nrs:(0.27e-6/w)'
+ mm_vfbc='nmvaa_vfbc_mm*6.505e-03/sqrt(par1*1e12*w*l)'
+ mm_mueph1='nmvaa_mueph1_mm*5.303e-03/sqrt(par1*1e12*w*l)'
+ mm_rdrmue='nmvaa_rdrmue_mm*3.677e-03/sqrt(par1*1e12*w*l)'
.if ( xf_subext==0 )
xddb b d dfwdnaa area=adl perimeter='max(pdl-(w+2*0.5e-6),0)' pgate='w+2*0.5e-6' m_soa=par1
.endif
rb1 b1 b r=1e-02
rbs b1 s r='extlay==0?1e-02:1e12'
m1 d g s b1 b1 nmvaamod w=w l='l+0.3e-6'
...
+ rdvb=0                        
+ cvdsover=0                    
+ vmax='nmvaa_vmax_mul*(1.374E+06)'       lvmax='nmvaa_vmax_mul*(843000)'
+ wvmax='nmvaa_vmax_mul*(2E+06)' pvmax='nmvaa_vmax_mul*(1.20245E+06)'
+ vmaxt1=-1.701e-03
+ vmaxt2=1.577e-06
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='mm_vfbc+nmvaa_vfbc_mul*(-1.012)' 
+ lvfbc='nmvaa_vfbc_mul*(0.106)'         
+ wvfbc=0.000e+00                        
+ pvfbc='nmvaa_vfbc_mul*(-0.0204)'       
+ vbi=1.100e+00
+ nsubc='nmvaa_nsubc_mul*(1.70623E+17)'   lnsubc='nmvaa_nsubc_mul*(1.089E+16)'
+ parl2=1.000e-08
+ lp=0.000e+00
+ nsubp=5E+17                   
+ nsubp0=0.000e+00
...
+ muecb1=4078.29                
+ mueph0=3.000e-01
+ mueph1='(1+mm_mueph1)*nmvaa_mueph1_mul*(24652)'
+ lmueph1=0.000e+00                      
+ wmueph1='nmvaa_mueph1_mul*(-1185)'     
+ pmueph1=0.000e+00                      
+ muephw=-2.000e-02
+ muepwp=1.000e+00
+ muephl=-5.983e-02
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(nmvaa_rdrmue)'  
+ rdrvmax=7.233e+06
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
+ rdrmuetmp=1.210e+00
