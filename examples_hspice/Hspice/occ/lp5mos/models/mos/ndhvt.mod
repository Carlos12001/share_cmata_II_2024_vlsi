...
*            par1 = m = multiplier
*
.subckt ndhvt d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  ndhvt_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param adl='(ad>=0)?ad:(3.36e-6*w)'
...
.endif
m1 d g s b1 sub ndhvtmod w='w+1e-6' l='l+0.55e-6'
...
+ copprv=1.000e+00             coadov=1.000e+00               coisub=0.000e+00
...
+ xl='ndhvt_xl'
+ xw='ndhvt_xw'
+ nsubc='ndhvt_nsubc_mul*5.535e+17'
+ nsubp=4.447e+18
...
+ lp=8.181e-08                 npext=5.000e+17                lpext=1.000e-50
+ vfbc='ndhvt_vfbc_mul*-3.930e+00'
+ vbi=1.100e+00                kappa=3.900e+00
+ eg0=1.220e+00                bgtmp1=8.149e-04               bgtmp2=-1.000e-06
****  velocity
+ vmax=1.008e+06
+ vmaxt1=0.000e+00             vmaxt2=0.000e+00
+ vover=2.139e+00              voverp=1.825e+00               vtmp=4.194e+00
+ lvtmp=7.846e-01
...
+ scp1=0.000e+00               scp2=8.000e-02                 scp3=0.000e+00
+ scp21=0.000e+00              scp22=0.000e+00
+ bs1=0.000e+00                bs2=9.000e-01
****  Mobility
+ muecb0=1.000e+02             muecb1=2.050e+01
+ mueph0=2.000e-01             muetmp=1.625e+00
+ mueph1=2.000e+03
+ muesr0=1.800e+00             muesr1=1.000e+14
+ ndep=2.425e-03               ndepl=7.000e+00                ndeplp=1.000e+00
+ muephl=-6.217e-01            mueplp=6.877e-01
+ mueslp=1.000e+00             muesrl=1.000e+00
+ ninv=9.624e-04               ninvd=6.680e+00                ninvdw=0.000e+00
+ ninvdwp=1.000e+00            ninvdt1=0.000e+00              ninvdt2=0.000e+00
+ bb=2.000e+00
****  Channel-Length Modulation
+ clm1=6.959e-01               clm2=2.000e+00                 clm3=1.000e+00
+ clm5=1.000e+00               clm6=0.000e+00
****  Narrow Channel Effect
+ wfc=0.000e+00                wvth0=-2.062e-01
+ nsubcw=3.637e-01             nsubcwp=1.000e+00
+ nsubp0=0.000e+00             nsubwp=1.000e+00
+ muephw=-1.246e+00            muepwp=1.000e+00
...
****  Substrate Current
+ sub1=9.420e-02               sub1l=0.000e+00                sub1lp=1.000e+00
+ sub2=1.043e+01               sub2l=0.000e+00                svds=1.670e-01
+ slg=3.000e-08                slgl=0.000e+00                 slglp=1.000e+00
+ svbs=5.000e-01               svbsl=0.000e+00                svbslp=1.000e+00
+ svgs=7.859e-01               svgsl=0.000e+00                svgslp=1.000e+00
...
+ rth0=3.592e+00               cth0=5.510e-07
+ rth0w=-1.559e+00             rth0wp=1.000e+00               rth0nf=0.000e+00
+ powrat=1.000e+00
...
+ vfbover=4.030e-01            cvdsover=0.000e+00
+ rdslp1=0.000e+00             rdslp2=1.000e+00
+ rdict1=1.000e+00             rdict2=1.286e-01
+ loverld='ndhvt_loverld'
+ lovers='ndhvt_lovers'
+ ldrift1=2.400e-06            ldrift2=0.000e+00
