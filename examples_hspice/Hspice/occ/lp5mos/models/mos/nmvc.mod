...
*            par1 = m = multiplier
*
.subckt nmvc d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  nmvc_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param adl='(ad>=0)?ad:(1.08e-6*w)'
+ asl='(as>=0)?as:(0.27e-6*w)'
+ pdl='(pd>=0)?pd:(w)'
+ psl='(ps>=0)?ps:(2*(w+0.27e-6))'
+ nrdl='(nrd>=0)?nrd:(0.21e-6/w)'
+ nrsl='(nrs>=0)?nrs:(0.27e-6/w)'
+ mm_vfbc='nmvc_vfbc_mm*1.410e-02/sqrt(par1*1e12*w*(l+4.500000e-07))'
+ mm_mueph1='nmvc_mueph1_mm*1.410e-02/sqrt(par1*1e12*w*(l+4.500000e-07))'
+ mm_rdrmue='nmvc_rdrmue_mm*7.070e-03/sqrt(par1*1e12*w*(l+4.500000e-07))'
xddb b d dfwdnc area=adl perimeter=pdl m_soa=par1
rb1 b1 b r=1e-02
rbs b1 s r='extlay==0?1e-02:1e12'
.if ( extlay==0 && xf_subext==0 )
cbox b sub c='3.45e-5*(w+1e-6)*(l+(4.34e-6/2-0.4e-06))'
.endif
m1 d g s b1 sub nmvcmod w='w' l='l+0.45e-6'
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='mm_vfbc+nmvc_vfbc_mul*(-1.14)'   
+ lvfbc='nmvc_vfbc_mul*(0.0256)'         
+ wvfbc=0.000e+00                        
+ pvfbc='nmvc_vfbc_mul*(-0.1805)'        
+ vbi=1.100e+00
+ nsubc='nmvc_nsubc_mul*(1.975E+17)'      
+ parl2=1.000e-08
+ lp=1.245e-07
+ nsubp=1.1735E+18              
+ nsubp0=8.115e-01
...
+ muecb1=237.66                 
+ mueph0=3.000e-01
+ mueph1='(1+mm_mueph1)*nmvc_mueph1_mul*(29843)'
+ lmueph1=0.000e+00                      
+ wmueph1=0.000e+00                      
+ pmueph1=0.000e+00                      
+ muephw=-5.294e-01
...
+ mueswp=1.000e+00
+ mueslp=1.000e+00
+ muetmp=2.1647                 lmuetmp=-0.97823
+ wmuetmp=-0.39717              pmuetmp=0.2137
+ bb=2.000e+00
+ sub1=0.0072192                
+ sub2=23.096                   
+ svgs=1.4376                   
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(nmvc_rdrmue)'   
+ rdrvmax='nmvc_rdrvmax'
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
+ rdrmuetmp=1.506e+00
