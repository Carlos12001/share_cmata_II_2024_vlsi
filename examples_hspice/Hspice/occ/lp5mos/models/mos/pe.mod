...
xocc_m1 d g s b  pe_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
*
.if ( xf_subext==0 )
m1 d g s b pemod w=w l=l ad=adl as=asl pd=pdl ps=psl nrd=nrdl nrs=nrsl
+ sa=sal sb=sbl sd=sdl
+ sca=scal scb=scbl scc=sccl
+ delvto='pe_vtmm*mfvt'
+ mulu0='(1+(pe_u0mm*mfu0))*pe_u0_mul'
.elseif ( xf_subext==1 )
m1 d g s b pemod w=w l=l ad=1e-15 as=1e-15 pd=0 ps=0 nrd=0 nrs=0
+ sa=sal sb=sbl sd=sdl
+ sca=scal scb=scbl scc=sccl
+ delvto='pe_vtmm*mfvt'
+ mulu0='(1+(pe_u0mm*mfu0))*pe_u0_mul'
