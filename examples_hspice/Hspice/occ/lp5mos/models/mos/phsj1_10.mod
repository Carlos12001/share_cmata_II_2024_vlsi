...
*            par1 = m = multiplier
*
.subckt phsj1_10 d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  phsj1_10_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param adl='(ad>=0)?ad:((w+0e-06)*10e-6)'
+ asl='(as>=0)?as:((0.52e-06*w))'
+ pdl='(pd>=0)?pd:(2*(w+0e-06))'
+ psl='(ps>=0)?ps:(2*(w+0.52e-06))'
+ nrdl='(nrd>=0)?nrd:(0)'
+ nrsl='(nrs>=0)?nrs:(0.27e-6/w)'
+ mm_vfbc='phsj1_10_vfbc_mm*1.200e-02/sqrt(par1*1e12*w*(l+1.500000e-06))'
+ mm_mueph1='phsj1_10_mueph1_mm*9.190e-03/sqrt(par1*1e12*w*(l+1.500000e-06))'
+ mm_rdrmue='phsj1_10_rdrmue_mm*5.660e-03/sqrt(par1*1e12*w*(l+1.500000e-06))'
xddb d b dfwpsj1_10 area=adl perimeter=pdl m_soa=par1
xdsb s b dp5 area=asl perimeter=psl m_soa=par1
m1 d g s b sub phsj1_10mod w='w+0e-6' l='l+1.5e-6'
+ ad=0 as=0 pd=0 ps=0 nrd=0 nrs=0
+ coselfheat='coselfheat?1:0'
.model phsj1_10mod pmos
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='mm_vfbc+(-1.2)'                   lvfbc=0.011
+ wvfbc=0                       pvfbc=0
+ vbi=1.100e+00
+ nsubc='phsj1_10_nsubc_m*(4.56E+17)'     lnsubc='phsj1_10_nsubc_m*(0)'
+ wnsubc='phsj1_10_nsubc_m*(0)' pnsubc='phsj1_10_nsubc_m*(0)'
+ parl2=1.000e-08
+ lp=5.712e-08
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(phsj1_10_rdrmue)'
+ rdrvmax='phsj1_10_rdrvmax'
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
+ rdrmuetmp=1.842e+00
