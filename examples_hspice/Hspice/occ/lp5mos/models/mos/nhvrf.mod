...
*            par1 = m = multiplier
*
.subckt nhvrf d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  nhvrf_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
+ mm_vfbc='nhvre_vfbc_mm*7.070e-03/sqrt(par1*1e12*w*(l+8.500000e-07))'
+ mm_mueph1='nhvre_mueph1_mm*1.060e-02/sqrt(par1*1e12*w*(l+8.500000e-07))'
+ mm_rdrmue='nhvre_rdrmue_mm*3.540e-03/sqrt(par1*1e12*w*(l+8.500000e-07))'
xddb b d dfwdnhf area=adl perimeter=pdl m_soa=par1
rb1 b1 b r=1e-02
rbs b1 s r='extlay==0?1e-02:1e12'
.if ( extlay==0 && xf_subext==0 )
cbox b sub c='3.45e-5*(w+1e-6)*(l+(18.8e-6/2-0.5e-06))'
.endif
m1 d g s b1 sub nhvrfmod w='w' l='l+0.85e-06'
...
+ vmax='nhvrf_vmax_m*(1.8E+06)'           lvmax='nhvrf_vmax_m*(6.026E+06)'
+ wvmax='nhvrf_vmax_m*(0)'      pvmax='nhvrf_vmax_m*(0)'
+ vmaxt1=-1.037e-03
+ vmaxt2=0.000e+00
+ bgtmp1=9.025E-05              
...
+ wvfbover=0
+ nover=5.236E+16               lnover=0
+ wnover=2E+16                  pnover=2E+16
+ novers=1.879E+17              
+ wnovers=0
+ olmdlt=5.000e+00
+ xwd=0.000e+00
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='mm_vfbc+nhvrf_vfbc_m*(-1.1)'     
+ lvfbc='nhvrf_vfbc_m*(0.03)'            
+ wvfbc='nhvrf_vfbc_m*(-0.18)'           
+ pvfbc='nhvrf_vfbc_m*(0.1)'             
+ vbi=1.100e+00
+ nsubc='nhvrf_nsubc_m*(4.148E+17)'       lnsubc='nhvrf_nsubc_m*(-1.656E+17)'
+ wnsubc='nhvrf_nsubc_m*(0)'    pnsubc='nhvrf_nsubc_m*(0)'
+ parl2=1.000e-08
+ lp=4.943e-08
...
+ wmuecb1=541.7                 pmuecb1=0
+ mueph0=2.969e-01
+ mueph1='(1+mm_mueph1)*nhvrf_mueph1_m*(18500)'
+ lmueph1='nhvrf_mueph1_m*(0)'           
+ wmueph1='nhvrf_mueph1_m*(0)'           
+ pmueph1='nhvrf_mueph1_m*(0)'           
+ muephw=-8.000e-02
+ muepwp=1.000e+00
+ muephl=-7.500e-01
+ mueplp=8.598e-01
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(nhvrf_rdrmue)'  
+ rdrvmax='nhvrf_rdrvmax'
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
+ rdrmuetmp='1.858*(1+1.334E-03*(temper-27)-7.447E-06*(temper-27)*(temper-27))'
