...
*            par1 = m = multiplier
*
.subckt nhvrc d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
xocc_m1 d g s b sub  nhvrc_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
.param adl='(ad>=0)?ad:(4.16e-06*w)'
...
xddb b d dfwdnhc area=adl perimeter=pdl m_soa=par1
rb1 b1 b r=1e-02
rbs b1 s r='extlay==0?1e-02:1e12'
.if ( extlay==0 && xf_subext==0 )
cbox b sub c='3.45e-5*(w+1e-6)*(l+(10.6e-6/2-0.4e-06))'
.endif
m1 d g s b1 sub nhvrcmod w='w' l='l+0.85e-06'
...
+ rs=0                          lrs=0
+ wrs=0                         prs=0
+ npext=1.423E+17               lnpext=0
+ wnpext=0
+ vover=0.7344                  lvover=0
+ wvover=0                      pvover=0
+ falph=0.9                     lfalph=0
+ wfalph=0                      pfalph=0
+ cgbo=0                        lcgbo=0
...
+ vmax='nhvrc_vmax_m*(1.6E+06)'           lvmax='nhvrc_vmax_m*(4.5E+06)'
+ wvmax='nhvrc_vmax_m*(0)'      pvmax='nhvrc_vmax_m*(-2E+06)'
+ vmaxt1=-1.037e-03
+ vmaxt2=0.000e+00
+ bgtmp1=9.769E-05              
+ bgtmp2=7.315E-07              lbgtmp2=-7E-07
+ wbgtmp2=0                     pbgtmp2=0
+ eg0=1.01                      
+ tox='nhvrc_tox'
+ xld=3.000e-08
...
+ xqy1=0.000e+00
+ xqy2=2.000e+00
+ vfbc='mm_vfbc+nhvrc_vfbc_m*(-1.098)'   
+ lvfbc='nhvrc_vfbc_m*(-6.514E-06)'      
+ wvfbc='nhvrc_vfbc_m*(0)'               
+ pvfbc='nhvrc_vfbc_m*(0.1)'             
+ vbi=1.100e+00
+ nsubc='nhvrc_nsubc_m*(3.338E+17)'       lnsubc='nhvrc_nsubc_m*(-2.5E+17)'
+ wnsubc='nhvrc_nsubc_m*(0)'    pnsubc='nhvrc_nsubc_m*(0)'
+ parl2=1.000e-08
+ lp=5.678e-08
+ nsubp=6.525E+18               lnsubp=0
+ nsubp0=0.000e+00
+ nsubwp=1.000e+00
+ scp1=0                        
+ scp2=0                        
...
+ wninv=0                       pninv=0
+ muecb0=52970                  lmuecb0=-5000
+ wmuecb0=-3000                 pmuecb0=0
+ muecb1=56.2                   lmuecb1=0
+ wmuecb1=541.7                 pmuecb1=-385.9
+ mueph0=2.969e-01
+ mueph1='(1+mm_mueph1)*nhvrc_mueph1_m*(17500)'
+ lmueph1='nhvrc_mueph1_m*(0)'           
+ wmueph1='nhvrc_mueph1_m*(0)'           
+ pmueph1='nhvrc_mueph1_m*(0)'           
+ muephw=0.000e+00
+ muepwp=1.000e+00
+ muephl=-8.050e-01
+ mueplp=8.598e-01
...
+ wvth0=0                       
+ muesr0=2.070e+00
+ muesr1=2.1E+14                lmuesr1=-1.487E+14
+ wmuesr1=0                     pmuesr1=2E+14
+ muesrl=0.000e+00
+ muesrw=-1.500e-02
+ mueswp=1.000e+00
+ mueslp=8.297e-01
+ muetmp=1.85                   lmuetmp=-1
+ bb=2.000e+00
+ sub1=0.02721                  
+ sub2=14.12                    
+ svgs=0.5047                   
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(nhvrc_rdrmue)'  
+ rdrvmax='nhvrc_rdrvmax'
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
+ rdrmuetmp='1.854*(1+2E-03*(temper-27)-14E-06*(temper-27)*(temper-27))'
