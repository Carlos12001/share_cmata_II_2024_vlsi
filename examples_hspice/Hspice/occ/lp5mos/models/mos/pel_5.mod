...
* Simulator : HSPICE
* Device    : pel_5
* Desc      : 1.8V low VT PMOS 5 terminals
...
*
.subckt pel_5 d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1 
+ xf_subext=0 par1=1 sa=-1 sb=-1 sd=-1 sca=-1 scb=-1 scc=-1
xocc_m1 d g s b sub  pel_5_ahdl tstep_occ=tstep_soac maxEv=maxEv maxEv_flg=maxEv_flg errFileName=str(errFileName)
...
*
m1 d g s b pel_5mod w=w l=l ad=adl as=asl pd=pdl ps=psl nrd=nrdl nrs=nrsl
