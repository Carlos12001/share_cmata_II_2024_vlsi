...
* Simulator : HSPICE
* Device    : phsj2b_13
* Desc      : 195V Gen2 Low Ron SJ PMOS
...
*            par1 = m = multiplier
*
.subckt phsj2b_13 d g s b sub w=1e-6 l=1e-6 ad=-1 as=-1 pd=-1 ps=-1 nrd=-1 nrs=-1
+ par1=1 ldrift=0 coselfheat=1 xf_subext=0 extlay=0
.param adl='(ad>=0)?ad:(13.75e-6*(w+4.6e-6))'
+ asl='(as>=0)?as:(0.52e-6*w)'
+ pdl='(pd>=0)?pd:(w+32.1e-6)'
+ psl='(ps>=0)?ps:(2*(w+0.52e-6))'
+ nrdl='(nrd>=0)?nrd:(0.75e-6/w)'
+ nrsl='(nrs>=0)?nrs:(0.27e-6/w)'
+ mm_vfbc='phsj2b_13_vfbc_mm*1.061e-02/sqrt(par1*1e12*w*l)'
+ mm_mueph1='phsj2b_13_mueph1_mm*1.768e-02/sqrt(par1*1e12*w*l)'
+ mm_rdrmue='phsj2b_13_rdrmue_mm*5.657e-03/sqrt(par1*1e12*w*l)'
xddb d b dfwpsj2b_13 area=adl perimeter=pdl m_soa=par1
rb1 b1 b r=1e-02
rbs b1 s r='extlay==0?1e-02:1e12'
m1 d g s b1 sub phsj2b_13mod w=w l='l+0.9e-6'
+ ad=0 as=0 pd=0 ps=0 nrd=0 nrs=0
+ coselfheat='coselfheat?2:0'
.model phsj2b_13mod pmos
...
+ rdvg11=0                      
+ rdict1=1                      
+ loverld='phsj2b_13_loverld'
+ wtrench=2.000e-07
+ lovers='phsj2b_13_lovers'
+ ldrift1=1.210e-05
+ ldrift2=0.000e+00
+ ldrift1s=0.000e+00
+ ldrift2s=0.000e+00
...
+ rdvb=0                        
+ cvdsover=0                    
+ vmax='phsj2b_13_vmax_mul*(5.50677E+06)' 
+ vmaxt1=0.000e+00
+ vmaxt2=0.000e+00
+ bgtmp1=9.025E-05              
+ bgtmp2=1E-07                  
...
+ vfbc='mm_vfbc+(-0.9769)'                
+ vbi=1.100e+00
+ nsubc='phsj2b_13_nsubc_mul*(4.05683E+17)' 
+ parl2=1.000e-08
+ lp=0.000e+00
+ nsubp=8.1895E+18              
+ nsubp0=0.000e+00
...
+ muecb1=86.3496                
+ mueph0=3.000e-01
+ mueph1='(1+mm_mueph1)*phsj2b_13_mueph1_mul*(5963.68)'
+ lmueph1=0.000e+00                      
+ wmueph1=0.000e+00                      
+ pmueph1=0.000e+00                      
+ muephw=1.000e+00
...
+ depfdpd=2.000e-01
+ depvgpsl=0.000e+00
+ rdrmue='(1+mm_rdrmue)*(phsj2b_13_rdrmue)'
+ rdrvmax='phsj2b_13_rdrvmax'
+ rdrmues=1.000e+03
+ rdrvmaxs=3.000e+07
+ rdrmuetmp=1.775e+00
