...
* Simulator : HSPICE
* Device    : drxw
* Desc      : Leakage Diode of device rxw2ti
...
*
.subckt drxw a c area=1e-12 perimeter=4e-6 pgate=0 dbv=0 xf_subext=0 par1=1 m_soa=1
.if ( xf_subext==0 )
rs a b r='dnw5_rs_m*(1e-10/area)'
+ tc1=2.030e-03 tc2=-1.593e-06
d1 b c drxwd1 area=area pj=perimeter pgate=pgate
d2 b c drxwd2 area=area
.endif
*
.model drxwd1 d level=6
