...
* TERMINALS: A=anode: PWS C=cathode: NDIFF
* NOTE: parameters are not extracted used dn5
* NOTE: special model for NVM IP
*
* VARIABLES: device area and perimeter
*
.subckt dn5ps a c area=1e-12 perimeter=4e-6 pgate=0 dbv=0 xf_subext=0 par1=1 m_soa=1
.if ( xf_subext==0 )
rs a b r='dn5_rs_m*(1e-10/area)'
+ tc1=2.933e-03 tc2=-1.153e-05
d1 b c dn5psd1 area=area pj=perimeter pgate=pgate
d2 b c dn5psd2 area=area
.endif
*
.model dn5psd1 d level=6
...
+ vbrbot='1.000e+00*(dbv+1.120e+01)'
+ vbrsti='1.000e+00*(dbv+1.120e+01)'
+ vbrgat='1.000e+00*(dbv+1.120e+01)'
+ pbrbot=1.300e+00             pbrsti=8.521e-01               pbrgat=1.033e+00
+ swjunexp=0.000e+00           vjunref=7.339e+00              fjunq=1.000e-02
*
.model dn5psd2 d level=1
+ n=1.000e+00
+ eg=1.110e+00
+ is=1.000e-18
+ xti=3.000e+00
