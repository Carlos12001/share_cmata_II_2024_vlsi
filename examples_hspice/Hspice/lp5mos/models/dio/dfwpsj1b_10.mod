...
*
.subckt dfwpsj1b_10 a c area=1e-12 perimeter=4e-6 pgate=0 dbv=0 par1=1 m_soa=1
d1 a c dfwpsj1b_10d1 ab=area ls='0' lg=pgate
d2 a c dfwpsj1b_10d2 area=area
*
.model dfwpsj1b_10d1 d level=7
...
+ vbrbot='1.000e+00*(dbv+1.922e+02)'
+ vbrsti='1.000e+00*(dbv+1.922e+02)'
+ vbrgat='1.000e+00*(dbv+1.922e+02)'
