...
* ----------------------------------------------------------------------
* Simulator : HSPICE
* Device    : mosvc5ti_nmos
* Desc      : 5V isolated P-Type moscap nmos core
* Model     : BSIM3V3, model
*           : hspice.mos_std2.nmosvc.model.1453
* Process   : xt018
...
*
*
.model mosvc5ti_nmos nmos
+ apwarn=0
+ version=3.24                 level=49
+ mobmod=1                     capmod=3
+ nqsmod=0                     binunit=2
+ tnom=27
+ xl=xl_mosvci5                xw=xw_mosvci5
+ lmlt=1.000e+00               wmlt=1.000e+00
+ tox=tox_mosvci5              toxm=tox_mosvci5
...
+ vfb=-2.032                    lvfb=0
+ wvfb=0                        pvfb=0
+ k1='1.189*(1+ 7.308E-03*(temper/27))' 
+ k2=-0.0006071                 
+ k3=6                          
+ k3b=10.75                     
+ nlx=4.449E-08                 
...
+ wuc=0                         puc=-3.679E-23
+ voff=-0.105                   
+ nch='7.967E+15*(1+ 55.25E-03*(temper/27))' 
+ nfactor=1.223                 
+ cit=0.0006794                 
+ cdsc=0.003452                 
+ cdscb=0.0008794               
